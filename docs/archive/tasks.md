## Legacy Task List (Pre‑v2.0.0)

This file is a preserved snapshot of the original granular task breakdown used while implementing the v2 roadmap.  
It is kept for historical/reference purposes only – the v2 feature set is now implemented.

The original content from `docs/tasks.md` follows:
